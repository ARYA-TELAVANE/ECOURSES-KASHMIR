const STORE = {
 questions: {
  accessibility: [
   {
    question: "Why is Ritalin abused?",
    code: ` `,
    answers: [
    ...
    correctAnswer: "For its stimulant effects"
   }],
  arrays: [
   {
    question: "What are some of Ritalin’s street names?",
    code: ` `,
    answers: [
    ...
    correctAnswer: "Skittles, Smarties, Vitamin R, Diet Coke"
   }],

  elements: [
    {
        question: "Even when Ritalin is used as a prescription drug, it may have severe effects including nervousness, insomnia, anorexia, loss of appetite, pulse changes, heart problems and weight loss.",
        code: ` `,
        answers: [
			"True",
			"False"        
  ...
  flexbox: [
    {
        question: "Why is Ritalin abuse dangerous?",
        code: ``,
        answers: [
         "Kids who abuse it are twice as likely to use street drugs",
         "Large doses put stress on the heart and can be fatal",
  ...
  forms: [
    {
        question: "What are some of the short-term effects of Ritalin abuse?",
        code: ``,
        answers: [
         "Damage to the lungs and eyes",
         "Visual hallucinations, suicidal thoughts and violent behavior",
         "Loss of appetite",
         "All of the above"
        ],
        correctAnswer: "All of the above"
  ...
  loops: [
    {
        question: "What are some of the long-term effects of Ritalin abuse?",
        code: ``,
        answers: [
            "Weight gain and high cholesterol",
            "Irreversible damage to blood vessels to the heart and brain, stroke and epilepsy",
			"Increased mental clarity and academic performance",
			"Self-denial"
           ],
        correctAnswer: "Irreversible damage to blood vessels to the heart and brain, stroke and epilepsy"
       }
