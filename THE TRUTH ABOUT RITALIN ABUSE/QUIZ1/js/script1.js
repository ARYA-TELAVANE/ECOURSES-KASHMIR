const STORE = {
 questions: {
  accessibility: [
   {
    question: "The word anorexia means:",
    code: ``,
    answers: [
     "A condition in which one feels like he cannot breathe and is suffocating",
     "Lack of appetite for food, in particular an emotional disorder characterized by an obsessive desire to lose weight",
     "Refusal to listen to people or have a conversation",
     "A persistent chilled condition, often evidenced by someone wearing excessive amounts of warm clothing"
    ],
    correctAnswer: "Lack of appetite for food, in particular an emotional disorder characterized by an obsessive desire to lose weight"
   },
//    {
...
//    }
  ...
  arrays: [
   {
    question: "The word hyperactivity means:",
    code: ``,
    answers: [
     "Abnormally or extremely active",
     "Breathing hard and fast",
     "When the heart rate is too high",
     "An abnormally active gland that controls the digestion of food in the body and results in weight loss"
    ],
    correctAnswer: "Abnormally or extremely active"
   }
//    ,{
...
//    }
  ...
  elements: [
    {
            question: "The word filler means:",
            code: ` `,
            answers: [
             "Empty boxes put on shelves to make them look stocked",
             "White bread",
             "Styrofoam peanuts, used in packaging",
             "Something used to increase bulk or fill a container"
            ],
            correctAnswer: "Something used to increase bulk or fill a container"
           }
   
  ],
//   flexbox: [
//     {
//         question: "The word diabetes means:",
//         code: ``,
//         answers: [
//          "The condition of being overweight and having too much fat in the body",
//          "A chronic disease characterized by excess sugar in the blood, excessive thirst, hunger and urination, and weakness",
//          "A disease caused by accumulating excessive preservatives in your body",
//          "A condition in which the eyesight gets gradually worse and worse from watching too much television"
//         ],
//         correctAnswer: "A chronic disease characterized by excess sugar in the blood, excessive thirst, hunger and urination, and weakness"
//        }
//   ]
//   forms: [
//     {
	...
	// This is if the app is just starting
		...
		$.when($('.question-answer-wrapper, .question-wrapper, .code, .answer-wrapper, .start-quiz, .quit-quiz, .results-wrapper, .progress, .progress-bar').fadeOut(500))
			.done(function(){
				...
				$('progress-bar').empty();
				$('progress-fill').html('Progress: <span class="progress-count">1 / 3</span><span class="progress-perc"></span>');
