const STORE = {
	questions: {
		accessibility: [
			{
				question: "Alcohol is a drug because:",
				code: ` `,
				answers: [
				...
				correctAnswer: "It is classed as a depressant, which means it slows down vital functions in your body"
			}],
		arrays: [
			{
				question: "Why is alcohol harder on teenagers than adults?",
				code: ` `,
				answers: [
				...
				correctAnswer: "Because their bodies are still growing"
			}],

		elements: [
			{
				question: "If a pregnant woman drinks alcohol, she may give birth to a baby with defects.",
				code: ` `,
				answers: [
					"True",
					"False"
		...
		flexbox: [
			{
				question: "When alcohol is taken with other drugs:",
				code: ``,
				answers: [
				...
				correctAnswer: "It is extremely dangerous and can be fatal"
			}

		],
		forms: [
			{
				question: "Some short-term effects of drinking alcohol are:",
				code: ``,
				answers: [
				...
				correctAnswer: "Loss of judgment and coordination, slurred speech, memory and comprehension loss"
			}

		],
		loops: [
			{
				question: "Some of the long-term effects of drinking alcohol are:",
				code: ``,
				answers: [
				...
				correctAnswer: "Liver damage and increased risk of heart disease"
			}
