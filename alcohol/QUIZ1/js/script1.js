const STORE = {
	questions: {
		accessibility: [
			{
				question: "The word blackout means:",
				code: ``,
				answers: [
					"Entering the darkness",
					"A temporary loss of consciousness, sight or memory",
					"Driving a car without headlights",
					"The name of an amusement park ride"
				],
				correctAnswer: "A temporary loss of consciousness, sight or memory"
			},
		],
		arrays: [
			{
				question: "The word delirium tremens means:",
				code: ``,
				answers: [
					"Uncontrollable laughter that makes your sides hurt",
					"Being afraid or nervous about something",
					...
					"What happens when you are sick with a fever"
				],
				correctAnswer: "A psychotic condition typical of withdrawal in chronic alcoholics, involving tremors, hallucinations, anxiety and disorientation"
			}

		],
		elements: [
			{
				question: "The word motor skills means:",
				code: ` `,
				answers: [
					"Dexterity and ease of coordination in the execution of body motions",
					"The ability to drive a car fast without having an accident",
					"Methods of fixing or repairing motors and engines",
					"Able to speak and write rapidly"
				],
				correctAnswer: "Dexterity and ease of coordination in the execution of body motions"
			}

		],
		flexbox: [
			{
				question: "The word toxicity means:",
				code: ``,
				answers: [
					"The measure of how radioactive something is",
					"The practice of stuffing and mounting animals so they look like they are still alive",
					"The amount of lead in house paint",
					"The state of being poisonous to somebody or something"
				],
				correctAnswer: "The state of being poisonous to somebody or something"
			}
		],
