const STORE = {
	questions: {
		accessibility: [
			{
				question: "The word disassociate means:",
				code: ``,
				answers: [
					"Represent someone who cannot attend a meeting",
					"Fire an employee (associate) from an organization",
					"Cut association with, disconnect from; no longer be involved with",
					"State disapproving or critical remarks about someone",
				],
				correctAnswer: "Cut association with, disconnect from; no longer be involved with"
			},
			//    {
		...
		arrays: [
			{
				question: "The word ergot fungus means:",
				code: ``,
				answers: [
					"An erratic (unpredictable) movement of the body",
					"The final stage of a fungus that kills the living thing it is growing on",
					"The measure of energy consumed by a mold or fungus on a living thing (such as mold on a dying plant or a fungus on a person’s foot)",
					"The mold called ergot which infects the flowers of wheat, rye and other grains and produces poisons that can harm humans and animals that eat the infected grain",
				],
				correctAnswer: "The mold called ergot which infects the flowers of wheat, rye and other grains and produces poisons that can harm humans and animals that eat the infected grain"
			}
			//    ,{
		...
		elements: [
			{
				question: "The word trip means:",
				code: ` `,
				answers: [
					"The action of switching on a light",
					"The experience produced by taking a drug such as LSD",
					"A daydream about a faraway place",
					"A muscle cramp caused by a drug"
				],
				correctAnswer: "The experience produced by taking a drug such as LSD"
			}
