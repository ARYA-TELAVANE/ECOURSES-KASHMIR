	 ...
	 accessibility: [
	  {
	   ...
	   correctAnswer: "A fungus"
	  }],
	 arrays: [
	  {
	   question: "How long do the effects of LSD last?",
	   code: ` `,
	   answers: [
		"Three hours",
	   ...
	   correctAnswer: "Twelve hours or more"
	  }],
   
	 elements: [
	   {
		   question: "In what different forms is LSD produced?",
		   code: ` `,
		   answers: [
			"It looks like children’s vitamin tablets in the shape of different cartoon characters",
			"It comes in tablets, capsules or in liquid form; it is commonly added to absorbent paper and divided into small decorated squares",
			"It looks like pieces of glass or small different-sized rocks",
			"It is a bright green or bright pink powder"
		   ],
		   correctAnswer: "It comes in tablets, capsules or in liquid form; it is commonly added to absorbent paper and divided into small decorated squares"
		 }
   
	 ],
	 flexbox: [
	   {
		   question: "If you have a “bad trip,” you can easily get out of it.",
		   code: ``,
		   answers: [
			"True",
			"False"
	 ...
	 forms: [
	   {
		   ...
		   answers: [
			...
			"Increased appetite and decreased body temperature",
			"Physical energy and increased endurance",
			"A zombie-like state",
			"All of the above"
		   ],
		   correctAnswer: "Severe terrifying thoughts, fear of losing control and fear of insanity and death"
		  }
	 ...
	 loops: [
	   {
		   ...
		   code: ``,
		   answers: [
			   "Flashbacks and long-lasting psychosis",
			   "Once the drug wears off, there are no longer any effects",
			   "Anger and aggression",
			   "Obesity and diabetes",
			  ],
		   correctAnswer: "Flashbacks and long-lasting psychosis"
		  }
