const STORE = {
	questions: {
		accessibility: [
			{
				question: "The word <i>delirium</i> means:",
				code: ``,
				answers: [
					"A state of wild excitement or happiness",
					"Extreme stupidity; denseness",
					"A fear of high places",
					"A state marked by extreme restlessness, confusion and sometimes hallucinations. It is caused by fever, poisoning or brain injury",
				],
				correctAnswer: "A state marked by extreme restlessness, confusion and sometimes hallucinations. It is caused by fever, poisoning or brain injury"
			},
		...
		arrays: [
			{
				question: "The word <i>hallucination</i> means:",
				code: ``,
				answers: [
					"The repeating echo of something said, such as “Hello” in a large valley or canyon",
					"The perception of somebody or something that is not really there, which is often a response to some drugs",
					"A daydream so real that the person does not respond to people around him",
					"A wiping away of one’s worries and problems so that life seems good, even though they still exist",
				],
				correctAnswer: "The perception of somebody or something that is not really there, which is often a response to some drugs"
			},
		],
		static: [	{
			    question: "The word <i>tactile</i> means:",
			    code: ``,
			    answers: [
			     "Relating to or used for the sense of touch",
			     "Stated bluntly, without consideration for someone’s feelings",
			     "Carefully stated so as to not upset someone",
			     "Sticky, like glue"
			    ],
			    correctAnswer: "Relating to or used for the sense of touch"
			   }
		],
		elements: [
			{
				question: "The prefix <i>hyper-</i> means:",
				code: ` `,
				answers: [
				...
				correctAnswer: "Excessive, unusually high"
			}
		  ...
		  methods: [
		    {
		        question: "The word <i>methamphetamine </i> means:",
		        code: ``,
		        answers: [
		         "A substance that makes a person fearless, originally created for the Marines to keep them going in spite of cold and dangerous waters",
		         "An amphetamine that can be taken in a variety of methods, such as snorting, smoking, intravenously, etc.",
		         "A highly addictive central nervous system (brain and spinal cord) stimulant; an illegal, man-made synthetic drug in the same class as cocaine and other powerful street drugs",
		         "A substance made from frogs or other cold-blooded animals"
		        ],
		        correctAnswer: "A highly addictive central nervous system (brain and spinal cord) stimulant; an illegal, man-made synthetic drug in the same class as cocaine and other powerful street drugs"
		       }
		  ],
		  CSS: [
		    {
		        question: "The word <i>narcotic</i> means:",
		        code: ``,
		        answers: [
		         "Producing an excessive amount of admiration and belief in oneself; the name comes from Greek mythology",
		         "Having to do with the department or division of a police force that arrests people who are up past the curfew time",
		         "A drug affecting the central nervous system (the brain and spinal cord), which can cause dizziness, euphoria, loss of memory, lack of coordination and unconsciousness. Many narcotics are derived from the opium poppy",
		         "Used to classify drugs of any kind that are illegal"
		        ],
		        correctAnswer: "A drug affecting the central nervous system (the brain and spinal cord), which can cause dizziness, euphoria, loss of memory, lack of coordination and unconsciousness. Many narcotics are derived from the opium poppy"
		       }
		  ],
