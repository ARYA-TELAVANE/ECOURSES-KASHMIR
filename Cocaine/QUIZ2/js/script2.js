const STORE = {
 questions: {
  accessibility: [
   {
    question: "Where does cocaine come from?",
    code: ` `,
    answers: [
     "A plant",
     "Man-made in a lab",
  ...
  arrays: [
   {
    question: "What happens when someone comes down from a cocaine “high”?",
    code: ` `,
    answers: [
    ...
    correctAnswer: "They become deeply depressed and may commit suicide"
   }],
...
//   ],
  flexbox: [
    {
        question: "Cocaine is not addictive.",
        code: ``,
        answers: [
         "True",
         "False"
  ...
  forms: [
    {
        question: "Cocaine creates a psychological dependence",
        code: ``,
        answers: [
         "True",
         "False",
  ...
  loops: [
    {
        question: "What are some of the short-term effects of cocaine?",
        code: ``,
        answers: [
        ...
        correctAnswer: "Paranoia, anger, hostility and anxiousness, even when they aren’t high"
       }

  ],
  blooper: [
    {
        question: "What are some of the long-term effects of cocaine?",
        code: ``,
        answers: [
            "Obesity and high blood pressure",
            "Increased fertility",
			"Irritability, paranoia and auditory (hearing) hallucinations",
			"Feeling cold all the time and a constant runny nose",
           ],
        correctAnswer: "Irritability, paranoia and auditory (hearing) hallucinationsh"
       }
