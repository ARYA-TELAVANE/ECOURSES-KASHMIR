const STORE = {
	questions: {
		accessibility: [
			{
				question: "The word <i>abstract</i> means:",
				code: ``,
				answers: [
					"Thought of apart from concrete realities, specific objects or actual instances, as an abstract idea",
					"A type of painting that is hard to understand",
					"Thin rope made from a plant with long stringy leaves",
					"An oil or essence obtained by pressing or crushing seeds",
				],
				correctAnswer: "Thought of apart from concrete realities, specific objects or actual instances, as an abstract idea"
			},
			//    {
		...
		arrays: [
			{
				question: "The phrase <i>delusions of power</i> means:",
				code: ``,
				answers: [
					"Authority granted to someone by the state to represent another person in a court of law",
					"When the electric company has scheduled power outages to save on electricity consumption",
					"When the power in a portable electronic device is used up and the device has to be recharged",
					"Gross and false overestimation of personal worth, importance, powerfulness or attractiveness",
				],
				correctAnswer: "Gross and false overestimation of personal worth, importance, powerfulness or attractiveness"
			}
			//    ,{
		...
		elements: [
			{
				question: "The word <i>derivative</i> means:",
				code: ` `,
				answers: [
					"A distant relative, such as an aunt, uncle or cousin",
					"A chemical substance formed from a related substance",
					"A second route, separate from a main highway, used to get to smaller towns and cities",
					"The source of something or where it comes from"
				],
				correctAnswer: "A chemical substance formed from a related substance"
			}
		...
		//   ],
		  CSS: [
		    {
		        question: "The word <i>rush</i> means:",
		        code: ``,
		        answers: [
		         "A sudden intake of air that a person takes when frightened or surprised",
		         "The reddening of the skin when a person gets too warm and is unable to cool down",
