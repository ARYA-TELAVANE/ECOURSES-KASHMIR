const STORE = {
 questions: {
  accessibility: [
   {
    question: "Methamphetamine comes from a plant.",
    code: ` `,
    answers: [
     "True",
     "False",
  ...
  arrays: [
   {
    question: "What does crystal meth look like?",
    code: ` `,
    answers: [
     "Small fragments of glass or shiny blue-white rocks",
     "Blue pills with cartoons on them",
     "A soft white powder that looks like flour",
     "A blue-green leafy plant"
    ],
    correctAnswer: "Small fragments of glass or shiny blue-white rocks"
   }],

  elements: [
    {
        question: "What are some street names for meth?",
        code: ` `,
        answers: [
        ...
        correctAnswer: "Speed, Crank, Tina and Ice"
      }

  ],
  flexbox: [
    {
        question: "Someone can become addicted to crystal meth from the very first use.",
        code: ``,
        answers: [
         "True",
         "False"
  ...
  forms: [
    {
        question: "Why is methamphetamine dangerous?",
        code: ``,
        answers: [
         "It begins to systematically destroy the body and is associated with serious health conditions including memory loss, aggression, psychotic behavior and potential heart and brain damage",
         "It is highly addictive and burns up the body’s resources, creating a devastating dependence that can only be relieved by taking more of the drug",
         "It is made from dangerous chemicals that are potentially explosive and can severely burn, disfigure or kill meth cooks when their preparations explode",
        //  "Relaxed muscles and an inner peace",
         "All of the above"
        ],
  ...
  bloopers: [
    {
        question: "What are some of the short-term effects of LSD?",
        code: ``,
        answers: [
        ...
        correctAnswer: "Disturbed sleep, hyperactivity and hallucinations"
       }

  ],
  loops: [
    {
        question: "What are some of the long-term effects of LSD?",
        code: ``,
        answers: [
        ...
        correctAnswer: "Brain damage and collapsed heart and blood vessels"
       }
	...
	// This is if the app is just starting
		...
		$.when($('.question-answer-wrapper, .question-wrapper, .code, .answer-wrapper, .start-quiz, .quit-quiz, .results-wrapper, .progress, .progress-bar').fadeOut(500))
			.done(function(){
				...
				$('progress-bar').empty();
				$('progress-fill').html('Progress: <span class="progress-count">1 / 6</span><span class="progress-perc"></span>');
