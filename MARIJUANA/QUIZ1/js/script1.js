const STORE = {
 questions: {
  accessibility: [
   {
    question: "The word gateway drug means:",
    code: ``,
    answers: [
     "A drug handed to someone as he enters a building",
     "A drug that gives someone enlightenment",
     "A drug which when used may lead to the use of more addictive drugs",
     "A drug that opens the door to better relationships with people"
    ],
    correctAnswer: "A drug which when used may lead to the use of more addictive drugs"
   },
//    {
  ...
  arrays: [
   {
    ...
    correctAnswer: "Having a temporary false feeling of happiness, with reduced physical and mental control, by use of alcohol or a drug"
   }
//    ,{
...
//    }
  ...
  elements: [
    {
            question: "The word laced means:",
            code: ` `,
            answers: [
             "Having lace around the edges of something",
             "Fastened to the feet or legs with shoe laces",
             "Added a small amount of a drug or alcohol to something",
             "Tied up with a thin piece of rope"
            ],
            correctAnswer: "Added a small amount of a drug or alcohol to something"
           }
   
  ],
  flexbox: [
    {
        question: "The word potency means:",
        code: ``,
        answers: [
         "How important something is",
         "The quantity of smell produced by rotting fruit",
         "The likelihood of someone to fall asleep while standing",
         "The strength of something such as a drug or alcoholic beverage"
        ],
        correctAnswer: "The strength of something such as a drug or alcoholic beverage"
       }
  ],
  forms: [
    {
        question: "The word tolerance means:",
        code: ``,
        answers: [
         "The natural or developed ability to resist the effects of the continued or increasing use of a drug",
         "Getting along with other people",
         "The ability to listen to very loud music",
         "Making allowances for breaking the rules"
        ],
        correctAnswer: "The natural or developed ability to resist the effects of the continued or increasing use of a drug"
       }
  ],
