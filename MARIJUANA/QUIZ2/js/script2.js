const STORE = {
 questions: {
  accessibility: [
   {
    question: "Marijuana comes from a plant.",
    code: ` `,
    answers: [
     "True",
     "False",
  ...
  arrays: [
   {
    question: "Which of the below statements is true?",
    code: ` `,
    answers: [
     "Marijuana use makes people eager to learn",
    ...
    correctAnswer: "Marijuana contains over 400 chemicals"
   }],

  elements: [
    {
        question: "How can the use of marijuana lead to harder drugs?",
        code: ` `,
        answers: [
         ...
         "A means of treating one’s addiction to marijuana is by taking other drug"
        ],
        correctAnswer: "Because a marijuana user builds up a tolerance to marijuana, he or she seeks out stronger drugs to reach the same degree of high"
      }

  ],
  flexbox: [
    {
        question: "Some short-term effects of marijuana are:",
        code: ``,
        answers: [
        ...
        correctAnswer: "Loss of coordination and distortions in the sense of time, vision and hearing"
       }

  ],
  forms: [
    {
        question: "Some long-term effects of marijuana are:",
        code: ``,
        answers: [
        ...
        correctAnswer: "Damage to the lungs and the heart"
       }
