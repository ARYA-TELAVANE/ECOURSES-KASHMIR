const STORE = {
	questions: {
		accessibility: [
			{
				question: "The word <i>anesthetics</i> means:",
				code: ``,
				answers: [
					"An exercise done to increase the circulation rate of the blood through the body",
					"Fragrant creams or lotions used to sooth irritated skin",
					"The fumes that come off of rotting compost or piles of cow manure",
					"Substances doctors use to stop a person from feeling pain during an operation, either in the whole body when unconscious or in a part of the body when awake",
				],
				correctAnswer: "Substances doctors use to stop a person from feeling pain during an operation, either in the whole body when unconscious or in a part of the body when awake"
			},
			//    {
		...
		arrays: [
			{
				question: "The word <i>butane</i> means:",
				code: ``,
				answers: [
					"A substance made from the liver of a cow",
					"A chemical found in rancid (spoiled) butter that inhibits, weakens or lowers a person’s energy level",
					"A gas obtained from petroleum and used as a fuel",
					"A blue coloring used in foods such as popsicles and sports drinks",
				],
				correctAnswer: "A gas obtained from petroleum and used as a fuel"
			}
			//    ,{
		...
		elements: [
			{
				question: "The word <i>solvent</i> means:",
				code: ` `,
				answers: [
					"A substance that dissolves another substance to form a solution (a mixture in liquid)",
					"An answer sheet for a test or exam",
					"A computer program that decodes digital locks and allows access to locked paint storage containers",
					"A person hired by a company to solve financial problems and increase profits"
				],
				correctAnswer: "A substance that dissolves another substance to form a solution (a mixture in liquid)"
			}
		...
		//   ],
		  methods: [
		    {
		        question: "The word <i>vaporize</i> means:",
		        code: ``,
		        answers: [
		         "To disappear, as in a magic act",
		         "To change into invisible particles floating in the air by heating or spraying",
		         "To disintegrate or decompose over hundreds of years",
		         "To become hard and brittle due to the loss of moisture"
		        ],
		        correctAnswer: "A drTo change into invisible particles floating in the air by heating or spraying"
		       }
		  ],
		  CSS: [
		    {
		        question: "The word <i>toluene</i> means:",
		        code: ``,
		        answers: [
		         "A substance obtained from the glands of pigs, used in some medicines",
		         "A chocolate bar with honey and almond nougat that is made in Switzerland",
		         "A strong-smelling chemical used to increase hair growth",
		         "A colorless liquid used as a solvent and a fuel"
		        ],
		        correctAnswer: "A colorless liquid used as a solvent and a fuel"
		       }
		  ],
