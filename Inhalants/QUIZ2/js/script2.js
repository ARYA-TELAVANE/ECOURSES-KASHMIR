const STORE = {
	questions: {
	 accessibility: [
	  {
	   question: "What are some of the ways chemical inhalants affect the body?",
	   code: ` `,
	   answers: [
	 ...
	 arrays: [
	  {
	   question: "What can happen to someone’s heart rate when they inhale dangerous chemicals?",
	   code: ` `,
	   answers: [
		"It slows down",
	   ...
	   correctAnswer: "The heart beats irregularly and more rapidly"
	  }],
   ...
   //   ],
	 flexbox: [
	   {
		   question: "Inhalants cause damage to the brain.",
		   code: ``,
		   answers: [
			"True",
			"False"
	 ...
	 forms: [
	   {
		   question: "What are some of the short-term effects of Inhalants?",
		   code: ``,
		   answers: [
		   ...
		   correctAnswer: "Death by heart attack or suffocation"
		  }
   
	 ],
	 loops: [
	   {
		   question: "What are some of the long-term effects of Inhalants",
		   code: ``,
		   answers: [
		   ...
		   correctAnswer: "Reduced muscle tone and strength"
		  }
