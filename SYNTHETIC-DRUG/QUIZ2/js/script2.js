const STORE = {
 questions: {
  accessibility: [
   {
    question: "What are some names of synthetic drugs?",
    code: ` `,
    answers: [
    ...
    correctAnswer: "Spice, K2, Bath Salts and N-bomb"
   }],
  arrays: [
   {
    question: "Why do chemists alter designer drugs?",
    code: ` `,
    answers: [
    ...
    correctAnswer: "They devise altered versions to steer clear of the law"
   }],

  elements: [
    {
        question: "What is sometimes referred to as “synthetic marijuana” is just like marijuana.",
        code: ` `,
        answers: [
         "True",
         "False",
  ...
  flexbox: [
    {
        question: "What are some of the short-term effects of synthetic drugs?",
        code: ``,
        answers: [
  ...
  forms: [
    {
        question: "What are some of the long-term effects of synthetic drugs?",
        code: ``,
        answers: [
        ...
        correctAnswer: "Forgetfulness, confusion, kidney injury and paralysis"
       }
