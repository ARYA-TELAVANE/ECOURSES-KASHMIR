const STORE = {
 questions: {
  accessibility: [
   {
    question: "The word auditory hallucination means:",
    code: ``,
    answers: [
     "The hearing of sound that is not really there",
     "A daydream about going to a concert",
     "A movie played with surround sound",
     "Delusions about having a lot of money"
    ],
    correctAnswer: "The hearing of sound that is not really there"
   },
//    {
...
//    }
  ...
  arrays: [
   {
    question: "The word cardiac arrest means:",
    code: ``,
    answers: [
     "A sudden stopping of a vehicle due to engine failure",
     "A sudden, sometimes temporary, stopping of the heart",
     "A mass arrest of the members of a drug dealership",
     "A condition in which a person suddenly falls asleep and cannot be woken up easily"
    ],
    correctAnswer: "A sudden, sometimes temporary, stopping of the heart"
   }
//    ,{
...
//    }
  ...
  elements: [
    {
            question: "The word designer drug means:",
            code: ` `,
            answers: [
             "Drugs used by famous fashion designers",
             "Drugs featured or advertised in fashion magazines",
             "Drugs used by clothing models to stay thin so designers will choose them to model new clothing designs",
             "Synthetic (chemically made) versions of illegal drugs that have been slightly altered to avoid classification as illegal"
            ],
            correctAnswer: "Synthetic (chemically made) versions of illegal drugs that have been slightly altered to avoid classification as illegal"
           }
   
  ],
  flexbox: [
    {
        question: "The words skeletal muscle tissue mean:",
        code: ``,
        answers: [
         "Tissues soaked with menthol for soothing sore muscles",
         "The hardened muscle tissue that forms into bones",
         "Muscles that bring about the movement of the bones of the skeleton",
         "A thin, light cloth used by body builders when lifting weights"
        ],
        correctAnswer: "Muscles that bring about the movement of the bones of the skeleton"
       }
  ],
