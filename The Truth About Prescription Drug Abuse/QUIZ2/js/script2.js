const STORE = {
 questions: {
  accessibility: [
   {
    question: "What can happen if sedatives or tranquilizers are taken with alcohol?",
    code: ` `,
    answers: [
    ...
    correctAnswer: "It can slow breathing and the heart, and even lead to death"
   }],
  arrays: [
   {
    question: "Why does “roofies” or Rohypnol have the reputation of a “date rape” drug?",
    code: ` `,
    answers: [
    ...
    correctAnswer: "The user experiences loss of muscle control and confusion, making him or her incapable of resisting"
   }],

  elements: [
    {
        question: "Opioids and morphine derivatives can result in physical dependence and addiction.",
        code: ` `,
        answers: [
			"True",
			"False"        
  ...
  flexbox: [
    {
        question: "Prescription drugs are safe for anyone because they are prescribed by a doctor",
        code: ``,
        answers: [
         "True",
         "False"
  ...
  forms: [
    {
        question: "Why are some drugs referred to as “depressants”?",
        code: ``,
        answers: [
        ...
        correctAnswer: "They slow down or depress brain function and breathing"
       }

  ],
  loops: [
    {
        question: "What are some of the side-effects of anti-depressants?",
        code: ``,
        answers: [
            "Weight loss",
        ...
        correctAnswer: "Violent or suicidal thoughts and actions"
       }
