const STORE = {
 questions: {
  accessibility: [
   {
    question: "The word bludgeon means:",
    code: ``,
    answers: [
     "A basement or cellar",
     "To hit with, or as if with, a heavy club",
     "To lie or deceive someone",
     "Fudge made with drugs added to the recipe"
    ],
    correctAnswer: "To hit with, or as if with, a heavy club"
   },
//    {
...
//    }
  ...
  arrays: [
   {
    question: "The word body chemistry means:",
    code: ``,
    answers: [
     "Any or all of the elements that make up the body as well as its various reactions",
     "The physical attraction felt for a sexual partner",
     "Heightened senses of sight, hearing, smell",
     "Used to refer to how much salt there is in the body"
    ],
    correctAnswer: "Any or all of the elements that make up the body as well as its various reactions"
   }
//    ,{
...
//    }
  ...
  elements: [
    {
            question: "The words cold flash mean:",
            code: ` `,
            answers: [
             "A sudden change in the weather to cooler temperatures",
             "A news announcement that has no interest and is not picked up by any news stations",
             "A sudden rush or sensation of coldness",
             "A procedure for chilling left-over foods for later use"
            ],
            correctAnswer: "A sudden rush or sensation of coldness"
           }
