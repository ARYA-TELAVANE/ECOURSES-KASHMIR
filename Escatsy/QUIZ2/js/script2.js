const STORE = {
 questions: {
  accessibility: [
   {
    question: "Ecstasy is a legal drug.",
    code: ` `,
    answers: [
     "True",
     "False",
  ...
  arrays: [
   {
    question: "What makes Ecstasy dangerous?",
    code: ` `,
    answers: [
    ...
    correctAnswer: "You never know what’s actually in the drug"
   }],

  elements: [
    {
        question: "How dangerous is it to take Ecstasy while drinking alcohol?",
        code: ` `,
        answers: [
        ...
        correctAnswer: "It can be deadly"
      }

  ],
  flexbox: [
    {
        question: "Ecstasy users risk death from dehydration (losing too much water from the body)",
        code: ``,
        answers: [
         "True",
         "False"
  ...
  forms: [
    {
        question: "What are some of the short-term effects of Ecstasy?",
        code: ``,
        answers: [
         "Involuntary teeth clenching, false sense of affection, paranoia, confusion and blurred vision",
         "Increased appetite, increased sense of self, increased physical strength and resistance to disease",
         "Improved mental clarity and good judgment",
         "Relaxed muscles and an inner peace",
        //  "All of the above"
        ],
        correctAnswer: "Involuntary teeth clenching, false sense of affection, paranoia, confusion and blurred vision"
       }
  ...
  loops: [
    {
        ...
        correctAnswer: "Permanent brain damage and memory impairment"
       }
