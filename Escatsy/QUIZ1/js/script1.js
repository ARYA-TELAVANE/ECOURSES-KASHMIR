const STORE = {
	questions: {
		accessibility: [
			{
				question: "The word <i>amphetamine</i> means:",
				code: ``,
				answers: [
					"A large outdoor arena where loud concerts are given and people take drugs",
					"Anything made from small, cold-blooded animals such as frogs or lizards",
					"Any of a group of powerful stimulant drugs, often called “speed,” that act on the central nervous system (the brain and the spinal cord), increasing heart rate and blood pressure while reducing fatigue",
					"Used to describe something that has two parts",
				],
				correctAnswer: "Any of a group of powerful stimulant drugs, often called “speed,” that act on the central nervous system (the brain and the spinal cord), increasing heart rate and blood pressure while reducing fatigue"
			},
			//    {
		...
		arrays: [
			{
				question: "The word <i>heatstroke</i> means:",
				code: ``,
				answers: [
					"A therapy where an attendant with warmed gloves massages the limbs of the body",
					...
					"A heart attack caused by an individual getting too hot",
					"A very intense thirst",
				],
				correctAnswer: "A condition caused by too long an exposure to high temperatures, causing high fever, headaches, hot, dry skin, physical exhaustion and sometimes physical collapse and coma"
			}
			//    ,{
		...
		elements: [
			{
				question: "The word <i>despressants</i> means:",
				code: ` `,
				answers: [
					"Drugs that slow down brain function including sedatives and tranquilizers",
					"Bad news that makes a person feel sad",
					"Bad grades",
					"Actions that show disapproval from one’s peers"
				],
				correctAnswer: "Drugs that slow down brain function including sedatives and tranquilizers"
			}
		...
		//   ],
		  CSS: [
		    {
		        question: "The word <i>hemorrhaging</i> means:",
		        code: ``,
		        answers: [
		         "Heavily criticizing someone",
		        ...
		        correctAnswer: "Heavy, serious bleeding of the body"
		       }
		  ],
