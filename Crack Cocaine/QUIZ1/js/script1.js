const STORE = {
	questions: {
		accessibility: [
			{
				question: "The word auditory means:",
				code: ``,
				answers: [
					"Very well done; deserving of praise",
					"Related to hearing",
					"Related to financial accounts",
					"Legally acceptable"
				],
				correctAnswer: "Related to hearing"
			},
		],
		arrays: [
			{
				question: "The phrase mood disturbances means:",
				code: ``,
				answers: [
					"When someone irritates you and puts you in a bad mood",
					"Disturbances in a person’s emotional life that may include feelings of sadness, hopelessness and worthlessness",
					"Interruptions in one’s concentration when trying to do something",
					"Feeling happy, then sad, then happy, then sad, on and on"
				],
				correctAnswer: "Disturbances in a person’s emotional life that may include feelings of sadness, hopelessness and worthlessness"
			}

		],
		elements: [
			{
				question: "The phrase reproductive damage means:",
				code: ` `,
				answers: [
					"Damage caused to the parts of the body having to do with the production of children",
					"Poor quality copies made by a copy machine",
					"A sporting phrase for penalty points applied when a player is tested positive for drug use",
					"A child born with deformities"
				],
				correctAnswer: "Damage caused to the parts of the body having to do with the production of children"
			}

		],
		flexbox: [
			{
				question: "The word tactile hallucination means:",
				code: ``,
				answers: [
					"Tasteless or perverted daydreams",
					"When someone experiences some perception related to touch when it is not really there",
					"A song or phrase that you cannot get out of your head",
					"A type of tree bark that looks like it is alive and moving"
				],
				correctAnswer: "When someone experiences some perception related to touch when it is not really there"
			}
		],
