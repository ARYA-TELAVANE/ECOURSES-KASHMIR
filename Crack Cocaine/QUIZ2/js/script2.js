const STORE = {
	questions: {
		accessibility: [
			{
				question: "Where does crack’s name come from?",
				code: ` `,
				answers: [
					"The person who first sold it in the 1980s, Crack Columbus",
					"The cracking or popping sound it makes when it is heated",
					"The fact that it is made in crystal form and is chipped or cracked off in pieces to be sold in small quantities",
					"The effects is has on people, from the informal use of “cracked” to mean crazy or insane"
				],
				correctAnswer: "The cracking or popping sound it makes when it is heated"
			}],
		arrays: [
			{
				question: "Using crack once can:",
				code: ` `,
				answers: [
					"Addict a person",
					"Greatly increase heartbeat, muscle spasms and convulsions",
					"Be followed by severe depression",
					"All of the above"
				],
		...
		elements: [
			{
				question: "Cocaine and crack cocaine are really exactly the same drug.",
				code: ` `,
				answers: [
					"True",
					"False"
		...
		flexbox: [
			{
				question: "Crack is even more dangerous than cocaine.",
				code: ``,
				answers: [
					"True",
					"False"
		...
		forms: [
			{
				question: "A crack addict:",
				code: ``,
				answers: [
					"Can lead an ordinary life",
					"Must take greater amounts of the drug more and more frequently, just to feel “normal”",
					"Can learn to live with the problem",
					"Has longer-lasting relationships"
				],
				correctAnswer: "Must take greater amounts of the drug more and more frequently, just to feel “normal”"
			}

		],
		loops: [
			{
				question: "What are some of the short-term effects of crack cocaine?",
				code: ``,
				answers: [
					"A long-lasting high",
					"Hair loss",
				...
				correctAnswer: "Feelings of paranoia, anger and nervousness"
			}

		],
		statics: [
			{
				question: "What are some of the long-term effects of crack cocaine?",
				code: ``,
				answers: [
					"Severe depression, tolerance and addiction (after just one use)",
					"Increased awareness",
					"Permanent hair loss",
					"Flaky skin"
				],
				correctAnswer: "Severe depression, tolerance and addiction (after just one use)"
			}
