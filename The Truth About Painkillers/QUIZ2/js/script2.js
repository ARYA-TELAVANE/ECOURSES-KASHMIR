const STORE = {
 questions: {
  accessibility: [
   {
    question: "What painkiller contains oxycondone?",
    code: ` `,
    answers: [
     "OxyContin",
     "Percocet",
     "Morphine",
     "Both OxyContin and Percocet",
    ],
    correctAnswer: "Both OxyContin and Percocet"
   }],
  arrays: [
   {
    question: "What are some of the short-term effects of painkillers?",
    code: ` `,
    answers: [
     "No short term effects exist",
     "High blood pressure",
     "Constipation, sedation, vomiting and weakness",
     "Heart attack and stroke"
    ],
    correctAnswer: "Constipation, sedation, vomiting and weakness"
   }],

  elements: [
    {
        question: "Oxycodone is as powerful as heroin and affects the nervous system the same way.",
        code: ` `,
        answers: [
			"True",
			"False"        
  ...
  flexbox: [
    {
        question: "What are some of the warning signs of prescription painkiller dependency?",
        code: ``,
        answers: [
         "Social withdrawal: withdrawal from family and friends",
         "Change in personality: shifts in energy, mood and concentration",
		 "Usage increase: increase of one’s dose over time, as a result o",
		 "All of the above"
        ],
  ...
  forms: [
    {
        question: "What is one of the long-term effects of painkillers?",
        code: ``,
        answers: [
         "Addiction",
         "Heart failure",
