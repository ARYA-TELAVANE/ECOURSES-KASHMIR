const STORE = {
 questions: {
  accessibility: [
   {
    question: "The word Appalachians means:",
    code: ``,
    answers: [
     "A brand of painkiller",
     "A mountain system in eastern North America, extending from southern Québec to north Alabama",
     "A type of horse bred for racing",
     "A dessert made from apples and brown sugar, sometimes illegally laced with drugs"
    ],
    correctAnswer: "A mountain system in eastern North America, extending from southern Québec to north Alabama"
   },
//    {
...
//    }
  ...
  arrays: [
   {
    question: "The word physiological means:",
    code: ``,
    answers: [
     "Relating to the way the body works",
     "Relating to the way the mind works",
     "Relating to exercise",
     "Relating to logical thought"
    ],
    correctAnswer: "Relating to the way the body works"
   }]
//    ,{
